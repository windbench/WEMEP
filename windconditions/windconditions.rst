...
.. csv-table:: Summary of open-access datasets for the validation of flow models for wind conditions (adapted from :cite:`rodrigo_new_2020`, CC BY 3.0 License)
   :file: windconditions_datasets.csv
   :widths: 5,5,5,5,30,5
   :header-rows: 1
   :class: longtable

.. note::
   Add open-access datasets from other projects when they have been used for flow model validation (provide references) and the data 
